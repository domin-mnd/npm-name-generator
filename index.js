...
const length = await readline.question("Enter package name length: ");
const quantity = await readline.question("Enter package name quantity: ");
...
console.log("[INFO]", "available package names:");
